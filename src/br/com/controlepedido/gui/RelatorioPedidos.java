...
public class RelatorioPedidos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Gerador de Relatórios - PEDIDOS");
        setToolTipText("");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/controlepedido/imagens24x24/Assignment.png"))); // NOI18N
    ...
    private void btGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGerarRelatorioActionPerformed
        if (rbPeriodoPedido.isSelected()) {
            if(dccDataInicial.getDate() == null || dccDataFinal.getDate() == null){
                ...
                rSer.CriarRelatorioDatas(datai, dataf);
            }
            ...
            try {
                ...
                rSer.CriarRelatorioPedido(numero);
